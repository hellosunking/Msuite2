...
CMD="$PRG/msuite2 -x hg38 -1 $PRG/testing_dataset/simu.read1.fq.gz -2 $PRG/testing_dataset/simu.read2.fq.gz -4 -m TAPS -q 0 -p $thread -o $PRG/testing_dataset/Msuite.Mode4"
...
## build makefile
CMD="$PRG/msuite2 -x hg38 -1 $PRG/testing_dataset/simu.read1.fq.gz -2 $PRG/testing_dataset/simu.read2.fq.gz -3 -m TAPS -q 0 -p $thread -o $PRG/testing_dataset/Msuite.Mode3"
echo -e "Command line: $CMD${BG}"
$CMD
if [ $? != 0 ]
then
